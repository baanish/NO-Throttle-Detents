...
- Initial prototype. Recorded testing covered identity and readiness across all 13 selectable airframes; FS-12, FS-20, KR-67, and AB-4 also passed reduced-dwell upper and lower control-path checks. The final release DLL received a manual flight check on the installed build.
