...
- The published package DLL SHA-256 is `803297E94829CC580E5240DB6CE1BF0AFD5DAC36C784869882D6C8A8EB4E209C`. It was rebuilt after correcting the author, plugin GUID, Harmony ID, and config namespace. Detent logic did not change; the identity-only DLL was not re-flown.
